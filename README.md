# 📝 Nik Aiman Hazriq - Personal Academic Portfolio Blog

A responsive personal portfolio website built using vanilla HTML, CSS, and JavaScript as part of the **CSD 34203 Special Topics in Software Development** course at Universiti Sultan Zainal Abidin (UniSZA).
...
|---|---|
| **HTML5** | Structural layout mechanics and accessible sections |
| **CSS3** | Editorial design framework, custom theme variable trees, and mobile grids |
| **JavaScript (ES6)** | Active theme persistence toggles, interactive navigation, and contact alerts |
| **Git & GitHub** | Version control workflows and deployment pipelines |
